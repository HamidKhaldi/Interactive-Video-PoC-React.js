            ...
            <div className="container">
                <div className="row videoArea">
                    {loading ? ( 
                        ...
                        <video id="video1" ref={videoPlayerRef} key={props.videoDetails.id} onLoadStart={launchAnimations} onEnded={() => { props.onVideoLinkClick(nextVideo) }} controls={true} autoPlay={true} mute="true">
